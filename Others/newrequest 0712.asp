...
//alert("msg");
	...
	if((frmobj.reqmgr.value == ""))
		{
		alert("Please select requestor's Manager ");
        frmobj.reqmgr.focus();
        return false;
		}
	if((frmobj.reqmgremail.value == ""))
		{
    ...
    //    return false;
	//	}
	if((frmobj.reqtitle.value == ""))
		{
		alert("please enter the Title ");
        frmobj.reqtitle.focus();
        return false;
		}
	if((frmobj.Desc.value == ""))
		{
...
%>
		<tr>
			...
			<td style="WIDTH: 120px" width=120><a href="/asr/upload/<%= Request.Form("fname")(i) %>"><%= Request.Form("fnamedis")(i) %></a>
...
%>
		<tr>
			<td width="30" class="trDet"><a href="javascript:DeleteRow(<%=introw%>);" ><img src="../images/delete.gif" border=0 width="22" height="19" border="0" align="absmiddle"></a>	</td>
			<td style="WIDTH: 120px" width=120><a href="/asr/upload/<%= Request.Form("fname1") %>"><%= Request.Form("fname1dis") %></a>
