	...
	<table width="900" border="0" cellspacing="0" cellpadding="5" bordercolor="#9966CC">
		...
		<tr>
			...
			<td align="left" class="rpthr" ><input type=button name=cmdlogin value="Open in Excel"
				onclick="javascript:document.location='rptintcostxl.asp?ipyear=<%=request("ipyear")%>&ipmonth=<%=request("ipmonth")%>'">
...
<%ElseIf pageAction  = "OK" then
	...
	Set rs=mobj.RetrieveIntCost(Request("ipyear")& Request("ipmonth"))	
	totamt=0	
	subtot=0 
	subtotdiv1=0 
	subtotdiv2=0 
