...
<form method="post"  id=form1 name=frmRep action="rptvolstat.asp">
	...
	<table width="500" border="1" cellspacing="1" cellpadding="5" bordercolor="#9966CC">
		...
		<tr>
			<td class="rpthr" align="middle">Monthly Volume Status Report</td>
	...
	If pageAction  = "OK" then
		...
		If DateDiff("m", Request("DtFrom"),Request("DtTo")) > 12 Then
			...
			<%
					...
					totReq = totReq +  rs.fields(11).value
					rs.movenext
